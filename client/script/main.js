...
function getAllStudent() {
     return new Promise((res, rej) => {
          $.ajax({
               url: "/server/get_all_students/getStudentsList",
               type: "GET",
...
function getAllStudentBySchool() {
     return new Promise((res, rej) => {
          $.ajax({
               url: "/server/get_all_students_by_school/getStudentsList?school_id=" + getSchoolId(),
               type: "GET",
               success: function (data) {
                    log(data);
                    res(data);
...
function getStudentByName() {
     ...
     $.ajax({
          url: "/server/get_student?name=" + name,
          type: "GET",
          success: function (data) {
               log(data);
...
function addStudent() {
     ...
     $.ajax({
          url: "/server/add_student/addStudent",
          type: "POST",
